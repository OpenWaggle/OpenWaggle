---
name: code-review
description: Review OpenWaggle pull requests and local diffs with repository-specific stack checks. Use for PR reviews, branch audits, and regression/security checks in this project.
license: Complete terms in LICENSE.txt
---

# Code Review

OpenWaggle-specific review workflow for this repository.
...
5. Run verification commands suggested by the analyzer and required OpenWaggle checks:
- `pnpm typecheck`
- `pnpm lint`
- `pnpm check`
...
## OpenWaggle stack checks (must enforce)
