...
MCP support is powered by the Pi extension package `npm:pi-mcp-adapter@2.5.4`. Settings > MCP enables or disables that package source in global Pi settings without deleting installed package files or MCP config files.
