...
- Renderer extension points should add or augment OpenWaggle surfaces through controlled slots and extension routes, not replace core shell layout/navigation or provide app themes.
