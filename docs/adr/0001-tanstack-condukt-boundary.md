...
- Date: 2026-02-20
- Owners: OpenWaggle Core

## Context

OpenWaggle uses TanStack AI as the primary runtime for model adapters, tool execution, and streaming chat behavior.  
...
3. OpenWaggle will not adopt Condukt provider helpers as part of the main runtime path.
...
- Allows OpenWaggle to benefit from Condukt orchestration without increasing runtime complexity.
...
## Pipeline and Trials in OpenWaggle

### Pipeline

Pipeline is valuable if OpenWaggle introduces deterministic non-chat workflows, for example:
...
3. We commit to maintaining Pipeline-oriented test coverage in OpenWaggle CI.
