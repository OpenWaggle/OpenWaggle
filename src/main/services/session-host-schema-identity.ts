...
export const SESSION_HOST_EXPORT_SELECTED_PATH_MIGRATION_ID = 31
export const SESSION_HOST_EXPORT_SELECTED_PATH_MIGRATION_NAME =
  'session-host-export-path-checkpoints'
export const SESSION_HOST_NODE_DELETE_MIGRATION_ID = 32
export const SESSION_HOST_NODE_DELETE_MIGRATION_NAME = 'session-host-cascade-safe-node-deletion'
export const SESSION_HOST_DISCOVERY_TERM_MIGRATION_ID = 33
export const SESSION_HOST_DISCOVERY_TERM_MIGRATION_NAME = 'session-host-native-discovery-signatures'
export const SESSION_HOST_DESKTOP_FENCE_MIGRATION_ID = 34
export const SESSION_HOST_BROWSER_ATTACHMENT_MIGRATION_ID = 35
...
export const SESSION_HOST_SUPPORTED_MAX_MIGRATION_ID = SESSION_HOST_BROWSER_ATTACHMENT_MIGRATION_ID
