...
export const SETTINGS_KEY_UPDATE_CHANNEL = 'updateChannel'
...
export const SETTINGS_KEY_AGENT_DEFINITION_TOGGLES_BY_PROJECT = 'agentDefinitionTogglesByProject'
...
export const SETTINGS_KEY_SELECTED_MODELS_BY_PROJECT = 'selectedModelsByProject'
export const SETTINGS_KEY_PROJECT_PATH_ALIASES = 'projectPathAliases'
