...
async function executeWriteFile(
  ...
  const result = await executeToolWithContext(writeFileTool, context, args)
...
async function executeEditFile(
  ...
  const result = await executeToolWithContext(editFileTool, context, args)
  return extractJsonResult(result)
}
...
async function executeRunCommand(
  ...
  const result = await executeToolWithContext(runCommandTool, context, args)
