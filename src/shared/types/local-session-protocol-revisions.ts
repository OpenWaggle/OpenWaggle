export const LOCAL_SESSION_CURRENT_REVISION = 15 as const
export const LOCAL_SESSION_NATIVE_ACTIONS_REVISION = 15 as const
...
export const LOCAL_SESSION_CAPABILITIES = LOCAL_SESSION_REVISION_15_CAPABILITIES
