...
export const MCP_ADAPTER_NPM_PACKAGE_SOURCE = `npm:${MCP_ADAPTER_PACKAGE_NAME}@${MCP_ADAPTER_PACKAGE_VERSION}`
export const MCP_ADAPTER_LEGACY_PACKAGE_SOURCES = [
  'npm:pi-mcp-adapter',
  MCP_ADAPTER_NPM_PACKAGE_SOURCE,
] as const
