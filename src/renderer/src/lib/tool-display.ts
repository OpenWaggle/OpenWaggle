...
const TOOL_CONFIG: Record<string, ToolConfig> = {
  readFile: { icon: FileText, displayName: 'Read File', primaryArg: 'filePath' },
  writeFile: { icon: FilePlus, displayName: 'Write File', primaryArg: 'filePath' },
  editFile: { icon: FileEdit, displayName: 'Edit File', primaryArg: 'filePath' },
  runCommand: { icon: Terminal, displayName: 'Run Command', primaryArg: 'command' },
  glob: { icon: Search, displayName: 'Glob', primaryArg: 'pattern' },
  listFiles: { icon: FolderTree, displayName: 'List Files', primaryArg: 'dirPath' },
}
