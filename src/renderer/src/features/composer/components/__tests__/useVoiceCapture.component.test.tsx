...
import type { VoiceVisualizerControls } from '../../hooks/useVoiceCapture'
...
vi.mock('@/features/composer/lib/voice-utils', async () => {
  const actual = await vi.importActual<typeof import('@/features/composer/lib/voice-utils')>(
    '@/features/composer/lib/voice-utils',
  )
  return {
    ...actual,
