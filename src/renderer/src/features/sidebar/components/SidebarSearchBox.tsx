  ...
  return (
    <div className="flex-none px-2 pt-1 pb-2">
      <div
        ...
        className="flex h-7 items-center gap-1.5 rounded-md border border-border-light bg-bg px-2 text-text-muted focus-within:border-progress"
      >
        ...
        <input
          ...
          className="min-w-0 flex-1 border-0 bg-transparent text-[12px] text-text-primary outline-none placeholder:text-text-muted"
        />
        <span
          aria-hidden="true"
