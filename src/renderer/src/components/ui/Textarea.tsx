...
import { DEFAULT_THEME, getHighlighter, resolveLanguage } from '@/lib/shiki/highlighter'
...
function getTextareaValue(value: TextareaHTMLAttributes<HTMLTextAreaElement>['value']): string {
...
function getHighlightedLines(
  tokensByLine: readonly (readonly ThemedToken[])[],
...
export function Textarea({
  ...
  function handleRef(node: HTMLTextAreaElement | null): void {
