  ...
  return (
    ...
    >
      ...
      <dialog
        ...
        className={cn(
          'absolute inset-y-0 right-0 left-auto m-0 h-full max-h-full min-w-0 max-w-none overflow-hidden border-l border-border bg-diff-bg p-0 text-inherit shadow-2xl shadow-bg/30 transition-transform duration-200 ease-out',
