...
```bash
npm install @openwaggle/extension-react @openwaggle/extension-sdk react react-dom
```
...
```bash
yarn add @openwaggle/extension-react @openwaggle/extension-sdk react react-dom
```
