---
title: "@openwaggle/extension-react API"
description: "Complete public API reference for @openwaggle/extension-react 0.2."
order: 90
section: "Packages"
---
...
This reference inventories every public entry point and named export in `@openwaggle/extension-react` 0.2.
...
Default host-aligned stylesheet for the React primitives.
