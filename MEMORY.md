...
- CI runs hidden-window functional Electron E2E on macOS, Linux under Xvfb, and Windows. Native pixel baselines stay Darwin-only and are selected with the `@visual` tag; do not copy them across operating systems.
