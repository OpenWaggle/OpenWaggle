...
export function useWorkspaceLifecycle() {
    ...
    const { activeSessionId, startDraftSession, loadSessions: loadChatSessions, refreshSession, updateSessionTitle, } = useChat();
    const { loadSessions: loadSessionTrees, refreshSessionTree } = useSessions();
    const { refreshStatus: refreshGitStatus, refreshBranches: refreshGitBranches, workingPath, repositoryPath, } = useGit();
