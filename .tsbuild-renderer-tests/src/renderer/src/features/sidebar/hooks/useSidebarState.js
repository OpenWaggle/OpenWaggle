...
function resolveActiveSessionState(activeChatSessionId, sessions) {
    ...
    const activeBranchId = matchingActiveWorkspace?.activeBranchId ?? matchingActiveSessionTree?.session.lastActiveBranchId;
...
export function useSidebarState() {
    ...
    const [collapsedProjectPaths, setCollapsedProjectPaths] = useState(() => new Set());
