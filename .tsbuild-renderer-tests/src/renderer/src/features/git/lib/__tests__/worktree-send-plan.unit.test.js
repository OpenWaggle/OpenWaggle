...
import { resolveDefaultWorktreeBaseRef, resolveWorktreeSendPlan, WORKTREE_BASE_REF_REQUIRED, WORKTREE_MISSING_REASON, } from '../worktree-send-plan';
describe('resolveWorktreeSendPlan', () => {
    it('proceeds for local-mode sessions', () => {
        expect(resolveWorktreeSendPlan({
            isFirstMessage: true,
            envMode: 'local',
            hasWorktree: false,
            baseRef: null,
