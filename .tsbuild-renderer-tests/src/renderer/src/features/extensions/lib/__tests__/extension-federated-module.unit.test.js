...
describe('extension federated module helpers', () => {
    it('creates a protocol URL for package-relative extension modules', () => {
        ...
        expect(moduleUrl).toBe('openwaggle-extension://runtime/module/%2Ftmp%2Fproject%2F.openwaggle%2Fextensions%2Fsample-extension/abcdef/%5B%22%2Ftmp%2Fproject%22%5D/dist/settings.js');
    });
    it('keeps package and hash context when extension modules import relative chunks', () => {
        ...
        expect(new URL('./chunk.js', moduleUrl).href).toBe('openwaggle-extension://runtime/module/%2Ftmp%2Fproject%2F.openwaggle%2Fextensions%2Fsample-extension/abcdef/%5B%22%2Ftmp%2Fproject%22%5D/dist/chunk.js');
    });
    it('includes session context for session-targeted extension modules', () => {
        ...
        expect(moduleUrl).toBe('openwaggle-extension://runtime/module/%2Ftmp%2Fproject%2F.openwaggle%2Fextensions%2Fsample-extension/abcdef/%5B%22%2Ftmp%2Fproject%22%5D/__context__/%7B%22sessionId%22%3A%22session-1%22%7D/dist/settings.js');
    });
    it('keeps session context when session modules import relative chunks', () => {
        ...
        expect(new URL('./chunk.js', moduleUrl).href).toBe('openwaggle-extension://runtime/module/%2Ftmp%2Fproject%2F.openwaggle%2Fextensions%2Fsample-extension/abcdef/%5B%22%2Ftmp%2Fproject%22%5D/__context__/%7B%22sessionId%22%3A%22session-1%22%7D/dist/chunk.js');
    });
