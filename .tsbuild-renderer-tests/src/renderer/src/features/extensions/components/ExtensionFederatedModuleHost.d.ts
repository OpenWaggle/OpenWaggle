...
export declare function ExtensionFederatedModuleHost({ entry, autoHeight, className, chrome, fill, maxAutoHeight, minAutoHeight, onSurfaceAction, surfacePayload, }: {
