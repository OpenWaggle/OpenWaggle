...
function renderWithQueryClient() {
    ...
    return render(_jsx(QueryClientProvider, { client: queryClient, children: _jsx(CommandPalette, { slashSkills: [], onSelectSkill: vi.fn(), onStartWaggle: vi.fn() }) }));
}
...
describe('CommandPalette extension commands', () => {
    ...
    it('uses app scope for app-only extension commands when a project is active', async () => {
        apiMock.listExtensionContributions.mockResolvedValueOnce(registryWith([
            sampleEntry({
