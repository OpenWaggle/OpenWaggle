...
export interface ComposerState {
    ...
    switchScopedDraftContext: (contextKey: string, fallbackDraft?: ComposerScopedDraft, currentDraftOverride?: ComposerScopedDraft) => ComposerScopedDraft;
...
export type ComposerSet = (partial: Partial<ComposerState> | ((state: ComposerState) => Partial<ComposerState>)) => void;
