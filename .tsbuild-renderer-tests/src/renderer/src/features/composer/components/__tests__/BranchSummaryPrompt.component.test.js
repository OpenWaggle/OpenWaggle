...
function renderPrompt() {
    ...
    render(_jsx(BranchSummaryPrompt, { onNoSummary: onNoSummary, onSummarize: onSummarize, onCustomSummary: onCustomSummary, onCancel: onCancel }));
...
describe('BranchSummaryPrompt', () => {
    ...
    it('explains that custom instructions use the composer input', () => {
        ...
        renderPrompt();
        expect(screen.getByText(/write custom summary instructions in the composer/i)).toBeInTheDocument();
    });
});
