...
export function MentionTypeaheadPlugin() {
    ...
    if (!isOpen)
        return null;
    return (_jsx(MentionTypeaheadDropdown, { items: suggestionState.suggestions, highlightIndex: suggestionState.highlightIndex, position: detection.position, onSelect: handleSelectMention, onClose: handleClose }));
}
