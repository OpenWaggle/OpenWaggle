...
export type AgentInteractionEvent = AgentTransportInteractionRequestEvent | AgentTransportInteractionResolvedEvent;
...
} | MessageChatRow | WaggleTurnChatRow | {
    type: 'agent-loop-custom-message';
    event: AgentTransportCustomEvent;
} | {
    type: 'agent-loop-interaction-event';
