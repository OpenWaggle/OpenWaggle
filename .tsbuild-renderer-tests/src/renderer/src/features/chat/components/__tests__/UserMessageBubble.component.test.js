...
function createUserMessage(id, parts) {
...
describe('UserMessageBubble', () => {
    ...
    it('renders text content from message parts', () => {
        ...
        render(_jsx(UserMessageBubble, { message: message }));
    ...
    it('applies user bubble CSS classes', () => {
        ...
        const { container } = render(_jsx(UserMessageBubble, { message: message }));
    ...
    it('calls the branch callback with the message id', () => {
        ...
        render(_jsx(UserMessageBubble, { message: message, onBranchFromMessage: onBranchFromMessage }));
    ...
    it('calls the fork callback with the message id', () => {
        ...
        render(_jsx(UserMessageBubble, { message: message, onForkFromMessage: onForkFromMessage }));
