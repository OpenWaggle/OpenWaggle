...
describe('ChatErrorDisplay', () => {
    it('shows raw transport error details without the renderer-created stack', () => {
        render(_jsx(ChatErrorDisplay, { error: new Error('Something went wrong'), lastUserMessage: "Draft a one-page summary", dismissedError: null, sessionId: null, onDismiss: vi.fn() }));
