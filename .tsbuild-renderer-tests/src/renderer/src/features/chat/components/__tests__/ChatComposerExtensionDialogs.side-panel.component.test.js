...
function sidePanelRegistry(kind) {
...
function dispatchSurfaceAction(frame) {
...
describe('ChatComposerExtensionDialogs side-panel launchers', () => {
    ...
    it('opens side-panel launchers and submits typed interaction responses', async () => {
        ...
        render(_jsx(ChatComposerExtensionDialogs, { agentInteractions: [interaction], extensionProjectPaths: [PROJECT_PATH], extensionRegistry: sidePanelRegistry('confirm'), onRespond: onRespond }));
