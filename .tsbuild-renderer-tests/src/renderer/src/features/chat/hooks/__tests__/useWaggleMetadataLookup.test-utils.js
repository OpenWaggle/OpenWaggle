...
export function makeSessionDetail(config, metadata) {
    return {
...
export function makeAssistantMessage(id) {
    return {
        id,
        role: 'assistant',
...
export function makeUserMessage(id) {
    return {
        id,
        role: 'user',
...
export function makeProjectedSession(config) {
    const architectMeta = {
        agentIndex: 0,
