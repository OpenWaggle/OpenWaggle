...
export type AgentChatStatus = 'ready' | 'submitted' | 'streaming' | 'compacting' | 'retrying' | 'error';
...
export interface AgentChatReturn {
    ...
    respondAgentInteraction: (interaction: AgentLoopInteraction, response: AgentLoopInteractionResponse) => Promise<void>;
}
...
export type SetAgentInteractionsBySessionId = (interactionsBySessionId: Map<SessionId, readonly AgentLoopInteraction[]>) => void;
export type SetAgentCustomMessagesBySessionId = (messagesBySessionId: Map<SessionId, readonly AgentTransportCustomEvent[]>) => void;
export type SetAgentInteractionEventsBySessionId = (eventsBySessionId: Map<SessionId, readonly AgentInteractionEvent[]>) => void;
export interface AgentStreamEventContext {
    ...
    readonly agentInteractionsBySessionIdRef: MutableValueRef<Map<SessionId, readonly AgentLoopInteraction[]>>;
    readonly agentCustomMessagesBySessionIdRef: MutableValueRef<Map<SessionId, readonly AgentTransportCustomEvent[]>>;
    readonly agentInteractionEventsBySessionIdRef: MutableValueRef<Map<SessionId, readonly AgentInteractionEvent[]>>;
