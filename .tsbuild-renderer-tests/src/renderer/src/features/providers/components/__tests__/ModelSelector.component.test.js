...
function TestHarness({ onChange }) {
    const settings = usePreferencesStore((s) => s.settings);
    const providerModels = useProviderStore((s) => s.providerModels);
    return (_jsx(ModelSelector, { value: settings.selectedModel, onChange: onChange, settings: settings, providerModels: providerModels }));
}
...
describe('ModelSelector', () => {
    ...
    it('shows flat list of models from enabledModels', () => {
        ...
        render(_jsx(TestHarness, { onChange: onChange }));
