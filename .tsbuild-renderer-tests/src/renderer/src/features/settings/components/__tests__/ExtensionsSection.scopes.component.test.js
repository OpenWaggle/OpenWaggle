...
const otherProjectPackage = {
    ...
    manifestPath: '/tmp/other-project/.openwaggle/extensions/other-extension/openwaggle.extension.json',
...
describe('ExtensionsSection scope inventory', () => {
    ...
    it('renders project packages under canonical project paths returned by the backend', async () => {
        const canonicalPackage = {
            ...
            manifestPath: '/tmp/canonical-project/.openwaggle/extensions/sample-extension/openwaggle.extension.json',
            projectOverride: {
                projectPath: '/tmp/canonical-project',
                disabled: false,
                updatedAt: null,
