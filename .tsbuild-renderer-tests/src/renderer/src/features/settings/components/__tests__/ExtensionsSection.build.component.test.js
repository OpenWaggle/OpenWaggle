...
const LOCAL_BUILD_VIEW = {
    projectPath: '/tmp/project',
    projectPaths: ['/tmp/project'],
    packages: [LOCAL_BUILD_PACKAGE],
};
const BUILD_APPROVED_VIEW = {
    ...LOCAL_BUILD_VIEW,
    packages: [
        {
            ...LOCAL_BUILD_PACKAGE,
...
describe('ExtensionsSection build approval', () => {
    ...
    it('renders failed build state returned by the build approval mutation', async () => {
        ...
        renderWithQueryClient(_jsx(ExtensionsSection, {}));
        fireEvent.click(await screen.findByRole('button', { name: 'Approve and build Sample Extension' }));
