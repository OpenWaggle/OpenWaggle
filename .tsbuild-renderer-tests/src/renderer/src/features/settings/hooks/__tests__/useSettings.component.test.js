...
const { loadSettingsMock, loadProviderModelsMock, loadAllAuthAccountsMock, onOAuthStatusMock, setPreferencesStateMock, unsubscribeMock, } = vi.hoisted(() => ({
...
function selectPreferences(selector) {
...
describe('useSettingsSetup', () => {
    ...
    it('waits for settings before loading provider models and auth accounts', async () => {
        let resolveSettings = () => { };
        loadSettingsMock.mockReturnValue(new Promise((resolve) => {
