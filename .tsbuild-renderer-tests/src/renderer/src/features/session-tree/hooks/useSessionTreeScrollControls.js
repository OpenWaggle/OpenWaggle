...
function shouldShowSessionTreeScrollButton(input) {
    ...
    const hasScrollableContent = input.scrollContainer.scrollHeight > input.scrollContainer.clientHeight;
...
export function useSessionTreeScrollControls() {
    ...
    function syncTreeScrollButtonVisibility() {
        setShowTreeScrollToBottom(shouldShowSessionTreeScrollButton({
